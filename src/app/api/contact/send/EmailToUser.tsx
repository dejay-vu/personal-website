        ...
        <Body className="bg-white my-auto mx-auto font-sans px-2">
          <Container className="border border-solid border-[#eaeaea] rounded my-4 mx-auto p-[20px] max-w-[465px]">
            <Section className="mt-[32px]">
              <Img
                src="https://resizer.dejayvu.com/avatar?format=auto&quality=75&width=128"
                width="60"
                height="60"
                alt="dio"
            ...
            <Section className="text-center mt-[32px] mb-[32px]">
              <Button
                ...
                href="mailto:junhao.zhang2301@gmail.com"
              >
                Send me an email
              </Button>
            </Section>
            ...
            <Text className="text-[#666666] text-[12px] leading-[24px]">
              This email was auto-generated by Jay&apos;s&nbsp;
              <Link href="dejayvu.com" className="text-blue-600 no-underline">
                personal website
              </Link>
